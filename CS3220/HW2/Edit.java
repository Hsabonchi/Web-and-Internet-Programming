...
protected CandidatesModel getEntry(int id) {
	...
	// Get a reference to our 
		...
		CandidatesModel ref=(CandidatesModel)getServletContext().getAttribute( "c" );
		
		CandidatesModel candidate=getEntry(id);
